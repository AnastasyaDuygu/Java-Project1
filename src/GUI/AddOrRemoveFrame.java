...
public class AddOrRemoveFrame extends JFrame {
	...
	public AddOrRemoveFrame() {
		...
		calcfeeBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int txt = Integer.parseInt(removeidTxt.getText());
				Borrower b = UniLibrarySys.searchPerson(txt);
				if(b.getOwnedBook()==null) {
					textArea.setText("Person doesn't have a book!!");
				} else {
